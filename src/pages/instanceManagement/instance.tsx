...
//   // ---------- row action handlers ----------
//   const handleActivateRow = useCallback(async (row: InstanceRecord) => {
//     try {
...
//             ? { ...item, instanceStatus: "ACT" }
//             : item
//         )
//       )

//       const response = await api.post("/tsp/v1/instance/activate-instance", payload)
...
//       // Revert on error
//       await load()
//       const msg = err?.response?.data?.message || err?.message || "Failed to activate instance"
//       setError(msg)
//     }
//   }, [load])

//   const handleDeactivateRow = useCallback(async (row: InstanceRecord) => {
//     try {
//       const generatedTraceId = generateTraceId()
//       const payload = {
//         traceId: generatedTraceId,
...
//         prevRows.map(item => 
//           item.instanceId === row.instanceId 
//             ? { ...item, instanceStatus: "DEACT" }
//             : item
//         )
//       )

//       const response = await api.post("/tsp/v1/instance/deactivate-instance", payload)
...
//       // Revert on error
//       await load()
//       const msg = err?.response?.data?.message || err?.message || "Failed to deactivate instance"
//       setError(msg)
//     }
//   }, [load])
...
//     r.instanceStatus?.toUpperCase() === "ACT" || r.instanceStatus?.toUpperCase() === "ACTIVE"
//   ).length
//   const deactiveCount = rows.filter(r => 
//     r.instanceStatus?.toUpperCase() === "DEACT" || r.instanceStatus?.toUpperCase() === "DEACTIVE"
//   ).length
